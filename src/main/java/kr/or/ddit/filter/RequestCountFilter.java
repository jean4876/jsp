...
import kr.or.ddit.filter.model.methodVO;
...
public class RequestCountFilter implements Filter {
	...
	private Map<methodVO, Integer> requestCountMethodMap = new HashMap<methodVO, Integer>();
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		int methodCount = requestCountMethodMap.getOrDefault(methodVO, 0);
		...
		requestCountMethodMap.put(methodVO, methodCount);
