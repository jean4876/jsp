...
public class FrontController extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		logger.debug("request methid : {}", req.getMethod());
		...
		/*
		 * if (uri.equals("/mvc/userList.do")) { IController controller = new
		 * UserListController(); controller.execute(req, resp);
		 *
		 * } else if (uri.equals("/mvc/memberList.do")) { IController controller = new
		 * MemberListController(); controller.execute(req, resp); }
		 */
	}
}
